...
void realDeal(DLinkedList<deck> dList);
int value(DLinkedList<deck> & hList, player & One, player & Two, int & turn);
void hit(DLinkedList<deck> dList, DLinkedList<deck> & hList, player One, player Two, int turn);
...
void shown(DLinkedList<deck> & dList, DLinkedList<deck> & hList, DLinkedList<deck> & hList2, player One, player Two, int turn){
	...
	if (turn < 3)
	{
		...
		/*cout << "Player One's shown: \n"; 
		hList.printHead(); 
		cout << "Player Two's shown: \n"; 
		hList2.printHead();*/
